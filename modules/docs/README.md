...
| is_valid_service_severity                                              | check if a service has a valid severity                                                                                                                      |
| [Documentation](sc_event.md#is_valid_service_severity-method)          |
| is_valid_acknowledgement_event                                         | check if the acknowledgement event is valid                                                                                                                  |
| [Documentation](sc_event.md#is_valid_acknowledgement_event-method)     |
| is_valid_author                                                        | check if the author of a comment is accepted                                                                                                                 |
| [Documentation](sc_event.md#is_valid_author-method)                    |
| is_valid_downtime_event                                                | check if the downtime event is valid                                                                                                                         |
| [Documentation](sc_event.md#is_valid_downtime_event-method)            |
| is_host_status_event_duplicated                                        | check if the host_status event is duplicated                                                                                                                 |
