...
function ScParams:check_params()
  ...
  self.params.drop_events_on_send_failure = self.common:check_boolean_number_option_syntax(self.params.drop_events_on_send_failure, 0)
